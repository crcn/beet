...
var Beet = EventEmitter.extend({
    ...
    'override __construct': function()
    {
        ...
        this._collection = gumbo.db({
            persist: {
                supervisord: require('./persist/supervisordconf').init(this, this.dirs.conf)
            }
        }).collection('scripts');
    },
    ...
    /**
     * Restart supervisord, and all processes
     */
    ...
    /**
     * Re-reads the config - starts / stops processes
     */

    'reloadConfig': function(callback)
    {
        this.client.reloadConfig(callback);
    }
});
